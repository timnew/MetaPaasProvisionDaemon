namespace ProvisionDaemon.ROOT.CIMV2 {
    using System;
    ...
    public class WinOperatingSystem : System.ComponentModel.Component {
        ...
        public WinOperatingSystem() {
            this.InitializeObject(null, new System.Management.ManagementPath(WinOperatingSystem.ConstructPath()), null);
        }
        
        public WinOperatingSystem(System.Management.ManagementScope mgmtScope) {
            this.InitializeObject(mgmtScope, new System.Management.ManagementPath(WinOperatingSystem.ConstructPath()), null);
        }
        
        public WinOperatingSystem(System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(null, new System.Management.ManagementPath(WinOperatingSystem.ConstructPath()), getOptions);
        }
        
        public WinOperatingSystem(System.Management.ManagementScope mgmtScope, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, new System.Management.ManagementPath(WinOperatingSystem.ConstructPath()), getOptions);
        }
        
        public WinOperatingSystem(System.Management.ManagementPath path) {
            this.InitializeObject(null, path, null);
        }
        
        public WinOperatingSystem(System.Management.ManagementScope mgmtScope, System.Management.ManagementPath path, System.Management.ObjectGetOptions getOptions) {
            this.InitializeObject(mgmtScope, path, getOptions);
        }
        
        public WinOperatingSystem(System.Management.ManagementObject theObject) {
            Initialize();
        ...
        public WinOperatingSystem(System.Management.ManagementBaseObject theObject) {
            Initialize();
            if ((CheckIfProperClass(theObject) == true)) {
...
10 - Windows Server 2003, Web Edition")]
        ...
        [Browsable(true)]
        public static WinOperatingSystem CreateInstance() {
            ...
            return new WinOperatingSystem(tmpMgmtClass.CreateInstance());
        }
